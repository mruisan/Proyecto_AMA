...
class EventoOcio:
    def __init__(self, organizador, titulo, descripcion, categoria, fecha_evento, lugar, participantes=None):
        self.organizador = organizador          	# Usuario que organiza
        ...
        self.participantes = participantes if participantes is list else [] # Lista de usuarios apuntados
